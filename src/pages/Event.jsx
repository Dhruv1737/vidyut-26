...
function StatBox({ value, label }) {
  return (
    <div className="text-center border-r border-white/10 last:border-r-0 px-4 sm:px-6 py-4">
      <p className="font-display text-[2rem] sm:text-[2.5rem] text-gold tracking-[.02em] leading-none">{value}</p>
      <p className="font-condensed font-semibold text-[10px] sm:text-[11px] tracking-[.14em] uppercase text-white/35 mt-1">{label}</p>
    </div>
  )
}
    ...
    <div className="w-full overflow-x-hidden">
      ...
      <section className="bg-forest px-4 sm:px-8 lg:px-14 py-16 sm:py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px]">
          ...
          <p className="text-white/55 font-light text-[15px] sm:text-[17px] leading-[1.75] max-w-[560px] mb-10 animate-fade-up-2">
      ...
      <section className="bg-sage px-4 sm:px-8 lg:px-14 py-16 sm:py-20">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            ...
            <p className="text-[15px] sm:text-[16px] font-light text-white/55 leading-[1.85] mb-5">
            ...
            <p className="text-[15px] sm:text-[16px] font-light text-white/55 leading-[1.85] mb-7">
          ...
          <ImageSlot filename="1000074954.jpg" label="Wide EV Lineup at Expo" className="h-64 sm:h-80 rounded" />
        </div>
      </section>
      ...
      <section className="bg-pine px-4 sm:px-8 lg:px-14 py-16 sm:py-20">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <ImageSlot filename="" label="Vaayu Robotics · Technical Partnership" className="h-64 sm:h-80 rounded" />
          <div>
      ...
      {/* ════════ VENUE ════════ */}
      <section className="bg-forest px-4 sm:px-8 lg:px-14 py-16 sm:py-20">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
          ...
          <div className="bg-pine border border-white/10 p-6 sm:p-10">
            <p className="text-[40px] sm:text-[48px] mb-4">📍</p>
            <p className="font-condensed font-bold text-[13px] tracking-[.15em] uppercase text-white/30 mb-2">Location</p>
            <p className="font-display text-[1.6rem] sm:text-[1.8rem] text-white tracking-[.02em] mb-1">MANIT Bhopal</p>
            <p className="text-[13px] sm:text-[14px] text-white/40 mb-6 sm:mb-8">Maulana Azad National Institute of Technology · Bhopal, MP 462003</p>
            <div className="grid grid-cols-3 gap-px bg-white/[.06]">
              {[['9 AM', 'Opens'], ['8 PM', 'Closes'], ['11 hrs', 'Duration']].map(([val, lbl]) => (
                <div key={lbl} className="bg-forest p-3 sm:p-4 text-center">
                  <p className="font-display text-[1.2rem] sm:text-[1.4rem] text-gold tracking-[.02em]">{val}</p>
                  <p className="font-condensed text-[10px] sm:text-[11px] tracking-[.1em] uppercase text-white/30 mt-1">{lbl}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="bg-sage px-4 sm:px-8 lg:px-14 py-16 sm:py-20">
        <div className="max-w-[1100px] mx-auto">
          ...
          <SectionTitle light className="mb-8 sm:mb-10">The Visual Proof</SectionTitle>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <GallerySlot filename="1000074951.jpg" label="Student Engagement" className="lg:row-span-2 min-h-[220px] sm:min-h-[380px]" />
            <GallerySlot filename="1000074952.jpg" label="Vehicle Interaction" className="min-h-[180px]" />
            <GallerySlot filename="1000074953.jpg" label="Branding Display"   className="min-h-[180px]" />
            <GallerySlot filename="1000074954.jpg" label="EV Lineup"          className="min-h-[180px]" />
            <GallerySlot filename="1000074955.jpg" label="Tech Models"        className="lg:col-span-2 min-h-[180px]" />
            <GallerySlot filename="1000074945.jpg" label="MANIT Campus"       className="min-h-[180px]" />
          </div>
        </div>
      </section>
