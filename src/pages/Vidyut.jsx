...
function PrizeCard({ rank, medal, amount, label, highlight }) {
  return (
    <div className={`bg-pine text-center p-6 sm:p-10 border border-white/[.06] hover:bg-sage2 transition-colors relative ${highlight ? 'border-t-[3px] border-t-gold' : ''}`}>
  ...
  return (
    <div className="relative pl-8 border-l-2 border-sage2 lg:border-none lg:pl-0 w-full overflow-hidden">
      <div className={`absolute -left-[9px] top-0 w-[18px] h-[18px] rounded-full border-2 lg:static lg:mb-6 flex-shrink-0 ${
        active ? 'bg-gold border-gold' : done ? 'bg-gold/40 border-gold/40' : 'bg-sage2 border-sage2'
      }`} />
      <div className="pb-10 lg:pb-0 mt-[-18px] lg:mt-0 w-full">
        ...
        <h3 className="font-display text-[1.6rem] sm:text-[1.9rem] tracking-[.02em] text-white mb-2 break-words">{name}</h3>
        <p className="text-[14px] font-light text-white/45 leading-[1.75] mb-3 break-words">{body}</p>
        <span className={`inline-block font-condensed font-bold text-[11px] tracking-[.1em] uppercase px-[10px] py-[3px] break-words ${
          tagGold ? 'bg-gold text-ink' : 'bg-sage2 text-white/70'
        }`}>{tag}</span>
      </div>
    </div>
  )
...
export default function Vidyut() {
  return (
    <div className="w-full max-w-full overflow-x-hidden bg-forest">
      ...
      <section className="bg-forest px-4 sm:px-8 lg:px-14 py-16 sm:py-24 relative overflow-hidden w-full max-w-full">
        ...
        <div className="absolute -left-20 -bottom-20 w-60 sm:w-80 h-60 sm:h-80 rounded-full bg-pine opacity-[.2] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-[900px] w-full">
          ...
          <h1 className="font-display text-white leading-[.95] tracking-[.01em] mb-6"
            style={{ fontSize: 'clamp(2.5rem, 7.5vw, 7rem)' }}>
            Recharging<br /><span className="text-gold">Innovation.</span>
          </h1>
          <p className="text-white/55 font-light text-[15px] sm:text-[17px] leading-[1.75] max-w-[560px] mb-10">
          ...
          <div className="flex flex-wrap gap-2 w-full">
            {['Sept 9, 2026', 'MANIT Bhopal', 'Tech Track 2.0', '₹18K Prize Pool', 'Open to All Engineers'].map((p, i) => (
              <span key={i} className={`font-condensed font-semibold text-[11px] sm:text-[12px] tracking-[.1em] uppercase px-2.5 py-[4px] border ${
      ...
      <section className="bg-sage px-4 sm:px-8 lg:px-14 py-16 sm:py-20 w-full max-w-full">
        <div className="max-w-[1100px] mx-auto w-full">
          ...
          <p className="text-white/45 font-light text-[15px] sm:text-[16px] leading-[1.85] max-w-[580px] mb-10">
      ...
      <section className="bg-pine px-4 sm:px-8 lg:px-14 py-16 sm:py-20 relative overflow-hidden w-full max-w-full">
        <div className="absolute -right-16 -bottom-16 w-72 h-72 sm:w-96 sm:h-96 rounded-full bg-forest opacity-40 pointer-events-none" />
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center relative z-10 w-full">
          ...
          <div className="w-full">
            <p className="font-condensed font-bold text-[11px] tracking-[.22em] uppercase text-gold/60 mb-2">Beyond The Prize</p>
            <h2 className="font-display text-white leading-[1] tracking-[.02em] mb-5"
            ...
            <p className="text-white/65 font-light text-[15px] sm:text-[16px] leading-[1.85] mb-7">
            ...
            <div className="flex flex-wrap gap-2 w-full">
              {['Paid Role', 'EV Engineering', 'Real Projects', 'Industry Exposure'].map((t) => (
                <span key={t} className="border border-gold/30 font-condensed font-semibold text-[11px] tracking-[.1em] uppercase px-2.5 py-[4px] text-gold/70">
                  {t}
                </span>
              ))}
            </div>
          ...
          {/* right */}
          <div className="bg-forest/60 border border-white/10 p-6 sm:p-10 w-full">
            <p className="font-condensed font-bold text-[11px] tracking-[.2em] uppercase text-white/30 mb-4">Partner Company</p>
            <h3 className="font-display text-[1.8rem] sm:text-[2.2rem] text-white tracking-[.02em] mb-3">Vaayu Robotics</h3>
            ...
            <div className="flex flex-col gap-3 w-full">
              {[
                ...
                <div key={text} className="flex items-start gap-3 text-[14px] text-white/55 w-full">
                  <span className="w-7 h-7 bg-white/[.06] border border-white/10 flex items-center justify-center flex-shrink-0 text-[14px] mt-0.5">
                    {icon}
                  </span>
      ...
      {/* ════════ TIMELINE ════════ */}
      <section className="bg-forest px-4 sm:px-8 lg:px-14 py-16 sm:py-20 w-full max-w-full border-t border-white/[.06]">
        <div className="max-w-[1100px] mx-auto w-full">
          <SectionEyebrow light>Schedule</SectionEyebrow>
          <SectionTitle light className="mb-3">Event Timeline</SectionTitle>
          <p className="text-[15px] sm:text-[16px] font-light text-white/40 leading-[1.85] max-w-[480px] mb-12">
          ...
          <div className="hidden lg:grid grid-cols-3 gap-0 relative w-full overflow-hidden">
            ...
            <TimelineItem
              date="August 29, 2026" name="Launch" done
            ...
            <div className="px-6">
              <TimelineItem
                date="September 5, 2026" name="Submissions Close" done
            ...
            <TimelineItem
              date="September 9, 2026" name="Grand Finale" active
